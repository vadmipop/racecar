...
if("TRUE" STREQUAL "TRUE")
  set(realsense2_description_SOURCE_PREFIX /root/catkin_ws/src/realsense2_description)
  set(realsense2_description_DEVEL_PREFIX /root/catkin_ws/devel/.private/realsense2_description)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'realsense2_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/realsense2_description/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/catkin_ws/devel/.private/realsense2_description/lib;/root/catkin_ws/devel/lib;/opt/ros/noetic/lib)
